...
Definir onde cada artefato de frontend deve viver — `shared`, `modules/<domain>` ou colocado na rota (`app/**/_components`) — para que a reorganização do Web tenha um critério único de propriedade, evitando promoção prematura ou componentes de domínio vazando para código compartilhado.
