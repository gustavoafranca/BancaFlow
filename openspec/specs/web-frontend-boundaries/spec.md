...
Estabelecer as fronteiras arquiteturais do Web — direção de dependências, composição fina em rotas, Server Components como default e a separação entre UI e regras de negócio autoritativas — para que o frontend não recrie DDD nem vaze regras/segredos de domínio.
