...
Define security configuration requirements for the backend, including secret management, CORS policy, input validation, and error handling to prevent information disclosure and ensure secure operation.
