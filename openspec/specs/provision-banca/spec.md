...
Define the banca provisioning workflow that atomically creates both a new Banca and its first OWNER account in a shared transaction. This ensures data consistency across the Tenancy and Identity domains.
